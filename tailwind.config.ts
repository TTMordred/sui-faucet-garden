	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'gradient-subtle': 'linear-gradient(to right, rgba(247, 248, 250, 0), rgba(247, 248, 250, 1) 50%, rgba(247, 248, 250, 0))',
			...
			boxShadow: {
				'neo': '5px 5px 10px rgba(0, 0, 0, 0.03), -5px -5px 10px rgba(255, 255, 255, 0.7)',
